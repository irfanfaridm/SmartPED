        ...
        <div class="mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="site_code" id="site_code" placeholder="Contoh: TSEL BOO821" 
                           class="w-full rounded border-gray-300 bg-white text-gray-900" value="{{ old('site_code', $document->site_code) }}">
                ...
                <div class="space-y-2">
                    ...
                    <select name="project_type" id="project_type" class="w-full rounded border-gray-300 bg-white text-gray-900">
                        ...
                        @foreach($projectTypes as $key => $value)
                            <option value="{{ $key }}" @if(old('project_type', $document->project_type) == $key) selected @endif>{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <select name="implementation_status" id="implementation_status" class="w-full rounded border-gray-300 bg-white text-gray-900">
                        ...
                        @foreach($implementationStatuses as $key => $value)
                            <option value="{{ $key }}" @if(old('implementation_status', $document->implementation_status) == $key) selected @endif>{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <select name="document_category" id="document_category" class="w-full rounded border-gray-300 bg-white text-gray-900">
                        ...
                        @foreach($documentCategories as $key => $value)
                            <option value="{{ $key }}" @if(old('document_category', $document->document_category) == $key) selected @endif>{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="order_reference" id="order_reference" placeholder="Contoh: ORD-2025-001" 
                           class="w-full rounded border-gray-300 bg-white text-gray-900" value="{{ old('order_reference', $document->order_reference) }}">
                ...
                <div class="space-y-2">
                    ...
                    <input type="date" name="completion_date" id="completion_date" 
                           class="w-full rounded border-gray-300 bg-white text-gray-900" value="{{ old('completion_date', $document->completion_date) }}">
            ...
            <div class="mt-4 space-y-2">
                ...
                <textarea name="equipment_specs" id="equipment_specs" rows="3" 
                          ...
                          placeholder="Contoh: Edge OTN Huawei OptiX RTN 950A, Mini OLT ZTE ZXA10 C320, dll">{{ old('equipment_specs', $document->equipment_specs) }}</textarea>
            ...
            <div class="mt-4 space-y-2">
                ...
                <textarea name="capacity_info" id="capacity_info" rows="3" 
                          class="w-full rounded border-gray-300 bg-white text-gray-900" 
                          placeholder="Contoh: Kapasitas 1000 pelanggan, Demand saat ini 500 pelanggan">{{ old('capacity_info', $document->capacity_info) }}</textarea>
            ...
            <div class="mt-4 space-y-2">
                ...
                <textarea name="technical_details" id="technical_details" rows="3" 
                          class="w-full rounded border-gray-300 bg-white text-gray-900" 
                          placeholder="Contoh: Implementasi menggunakan teknologi GPON, Topologi star, dll">{{ old('technical_details', $document->technical_details) }}</textarea>
            ...
            <div class="mt-4 space-y-2">
                ...
                <textarea name="remarks" id="remarks" rows="2" 
                          class="w-full rounded border-gray-300 bg-white text-gray-900" 
                          placeholder="Catatan tambahan atau informasi penting lainnya">{{ old('remarks', $document->remarks) }}</textarea>
            </div>
        </div>
